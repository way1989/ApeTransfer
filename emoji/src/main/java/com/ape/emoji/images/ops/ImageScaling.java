...
import com.ape.emoji.images.common.WorkCache;
...
public class ImageScaling {
    ...
    public static void scaleFill(Bitmap src, Bitmap dest) {
        scaleFill(src, dest, ImageDrawing.CLEAR_COLOR);
    }
    ...
    public static void scaleFit(Bitmap src, Bitmap dest) {
        scaleFit(src, dest, ImageDrawing.CLEAR_COLOR);
    }
    ...
    public static void scale(Bitmap src, Bitmap dest) {
        scale(src, dest, ImageDrawing.CLEAR_COLOR);
    }
    ...
    public static void scale(Bitmap src, Bitmap dest,
                             ...
                             int dx, int dy,
                             int dw, int dh) {
        scale(src, dest, ImageDrawing.CLEAR_COLOR, x, y, sw, sh, dx, dy, dw, dh);
    }
    ...
    public static void scale(Bitmap src, Bitmap dest, int clearColor,
                             ...
                             int dx, int dy,
                             int dw, int dh) {
        ImageDrawing.clearBitmap(dest, clearColor);
