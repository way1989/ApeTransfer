...
import com.ape.emoji.Screen;
import com.ape.emoji.SmileProcessor;
import com.ape.emoji.keyboard.BaseKeyboard;
import com.ape.emoji.keyboard.emoji.smiles.OnBackspaceClickListener;
import com.ape.emoji.keyboard.emoji.smiles.OnSmileClickListener;
import com.ape.emoji.keyboard.emoji.smiles.RepeatListener;
import com.ape.emoji.keyboard.emoji.smiles.SmilePagerAdapter;
...
public class EmojiKeyboard extends BaseKeyboard implements OnSmileClickListener,
    ...
    protected View createView() {
        ...
        emojiPagerIndicator.setTabLayoutParams(new LinearLayout.LayoutParams(Screen.dp(activity.getApplicationContext(), 48),
                Screen.dp(activity.getApplicationContext(), 48)));
