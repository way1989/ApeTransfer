...
import com.ape.emoji.keyboard.emoji.smiles.OnRecentChangeListener;
...
public class SmilesPack {
    ...
    public static ArrayList<Long> getRecent(Context context) {/*
                if (recent.isEmpty()) {
                        recent.addAll(Arrays.asList(RECENT_DEFAULT));
                }
                return recent;*/
        return SmilesRecentsController.getInstance(context);
    }

    public static void upRecent(Context context, Long smileId) {
        SmilesRecentsController.getInstance(context).push(smileId);
    }
}
