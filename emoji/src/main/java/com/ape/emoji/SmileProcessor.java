...
import com.ape.emoji.images.IOUtils;
import com.ape.emoji.images.common.ImageMetadata;
import com.ape.emoji.images.ops.ImageLoading;
import com.ape.emoji.images.sources.FileSource;
import com.ape.emoji.keyboard.emoji.smiles.SmilesListener;
import com.ape.emoji.smiles.SmilesPack;
import com.ape.emoji.smiles.SmilesRecentListener;
import com.ape.emoji.smiles.SmilesRecentsController;
import com.ape.emoji.smiles.SmileysPack;
...
public class SmileProcessor {
    ...
    public void upRecent(Context context, long smileId) {
        SmilesPack.upRecent(context, smileId);
