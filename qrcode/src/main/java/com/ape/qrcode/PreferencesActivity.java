...
public class PreferencesActivity {
    public static final int MSG_DECODE = 0x001;
    public static final int MSG_QUIT = 0x002;
    public static final int MSG_RESTART_PREVIEW = 0x003;
    public static final int MSG_DECODE_SUCCEED = 0x004;
    public static final int MSG_DECODE_FAILED = 0x005;
    public static final int MSG_RETURN_SCAN_RESULT = 0x006;
    public static final int MSG_LAUNCH_PRODUCT_QUERY = 0x007;
